[boots](../../../index.md) / [com.agoda.boots](../../index.md) / [Key](../index.md) / [Multiple](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Multiple(keys: `[`Set`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-set/index.html)`<`[`Key.Single`](../-single/index.md)`>)`<br>Multiple key. Marks a set of [single](../-single/index.md) keys. |
